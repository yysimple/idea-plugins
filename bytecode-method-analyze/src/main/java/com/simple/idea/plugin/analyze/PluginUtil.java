package com.simple.idea.plugin.analyze;
 ...
 *
 * @author: WuChengXing
 * @create: 2022-04-15 15:52
 **/
public class PluginUtil {
    private static final IdeaPluginDescriptor IDEA_PLUGIN_DESCRIPTOR;

    static {
        PluginId pluginId = PluginId.getId("com.simple.bytecode-method-analyze");
    ...
    public static String getAgentCoreJarPath() {
        return getJarPathByStartWith("VisitMethod");
    }
